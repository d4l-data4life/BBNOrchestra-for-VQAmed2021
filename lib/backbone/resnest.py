...
class BBNX(nn.Module):
   ...
   """
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64, dilated=False, dilation=1,
        ...
        self.cb_block = block(self.inplanes, self.inplanes // 4, stride=1, norm_layer=norm_layer)
        self.rb_block = block(self.inplanes, self.inplanes // 4, stride=1, norm_layer=norm_layer)
